 ...
 */
final class Version20220216205404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE first ADD util_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE first ADD CONSTRAINT FK_9271EE57CF5D2E80 FOREIGN KEY (util_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE first DROP util_id, CHANGE statut statut VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE commentaires commentaires LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
