 ...
 */
final class Version20220217164715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE first_user (first_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_7A61697DE84D625F (first_id), INDEX IDX_7A61697DA76ED395 (user_id), PRIMARY KEY(first_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE first_user ADD CONSTRAINT FK_7A61697DE84D625F FOREIGN KEY (first_id) REFERENCES first (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE first_user ADD CONSTRAINT FK_7A61697DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
    }
